...
from .models import GenrateVideo, SearchTerm, Video, Platform, Accounts
from .serializers import GenrateVideoSearializer, SearchTermSerializer, VideoSerializer, UserSerializer, PlatformSerializer, AccountsSerializer
