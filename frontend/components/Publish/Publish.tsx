...
// load all accounts
  ...
  const handleChangeTitle = (event:any,key:number)=>{
  ...
  const handleChangeDescription = (event:any,key:number)=>{
      ...
      <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
        ...
        <div className="w-full xl:w-1/2">
          ...
          <input
            ...
            value={video.title}
            onChange={(e)=>handleChangeTitle(e, key)}
          />


          <div>
            <label className="mb-3 mt-4 block text-black dark:text-white">
              Select Account
            </label>
